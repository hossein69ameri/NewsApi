package com.ameri.presentation.ui.home.food_section
...
@Composable
fun FoodItem(item: com.ameri.remote.models.ResponseData.Data) {
    Box(
        modifier = Modifier
            .width(300.dp)
            .height(200.dp),
...
@Composable
fun FoodItemPreview() {
    FoodItem(com.ameri.remote.models.ResponseData.Data())
}